...
The packages have been on NuGet.org since 0.2.0 and the current release is 0.8.0: see
...
<Project Sdk="Microsoft.NET.Sdk">
  <Sdk Name="DotProlog.Sdk" Version="0.8.0" />
```
...
The packages are published on NuGet.org as `DotProlog.*`, starting at 0.2.0 and currently at 0.8.0.
