...
| `library(ordsets)`: `list_to_ord_set/2`, `ord_empty/1`, `ord_memberchk/2`, `ord_subset/2`, `ord_disjoint/2`, `ord_union/3`, `ord_intersection/3`, `ord_subtract/3`, `ord_add_element/3`, `ord_del_element/3`, `ord_union/2`, `ord_intersection/2` | Supported. `ord_seteq/2` and `ord_symdiff/3` are absent |
| All-solutions: `findall/3,4`, `bagof/3`, `setof/3`, `forall/2`, `aggregate_all/3,4`, `aggregate/3,4` | Supported for the simple specs `count`, `count/1`, `bag/1`, `set/1`, `sum/1`, `max/1`, `min/1`; SWI's compound templates such as `r(sum(X), count)` and the witnessed `max/2`, `min/2` are absent |
