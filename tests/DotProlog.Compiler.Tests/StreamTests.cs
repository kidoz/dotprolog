...
public sealed class StreamTests : IDisposable
{
    ...
    [InlineData("get_code(1114112)", "representation_error(in_character_code)")]
    [InlineData("get_code(55296)", "representation_error(in_character_code)")]
    ...
    [InlineData("put_code(1114112)", "representation_error(character_code)")]
    [InlineData("put_code(56320)", "representation_error(character_code)")]
